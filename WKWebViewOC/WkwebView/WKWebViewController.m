...
-(void)webView:(WKWebView *)webView didFailProvisionalNavigation:(WKNavigation *)navigation withError:(NSError *)error{
    NSLog(@"页面加载超时");
     [self.wkWebView evaluateJavaScript:@"alertSendMsg('我是参数1','我是参数2')" completionHandler:nil];
}
...
- (IBAction)oneParameter:(id)sender {
     ...
     *奥特们打小怪兽 带的参数
     */
    [self.wkWebView evaluateJavaScript:@"alertName('奥特们打小怪兽')" completionHandler:nil];
}
//两个参数
...
-(void)removeAllScriptMsgHandle{
    WKUserContentController *controller = _wkWebView.configuration.userContentController;
